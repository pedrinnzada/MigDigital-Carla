...
window.addEventListener('scroll',()=>{
  ...
  // ─── Attendants data ─────────────────────────
  const attendants = [
    { name: 'David Thiago', role: 'Consultor de Crédito', whatsapp: '5531988055995' },
    { name: 'Carla', role: 'Consultora de Crédito', whatsapp: '5531988055995' },
    { name: 'Ronaldo', role: 'Consultor de Crédito', whatsapp: '5531988055995' },
    { name: 'Leonardo', role: 'Consultor de Crédito', whatsapp: '5531988055995' },
    { name: 'Ana', role: 'Consultora de Crédito', whatsapp: '5531988055995' },
    { name: 'Everton', role: 'Consultor de Crédito', whatsapp: '5531988055995' },
    { name: 'Luiz', role: 'Consultor de Crédito', whatsapp: '5531988055995' }
  ];
